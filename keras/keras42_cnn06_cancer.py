...
dense1 = Dense(7000, activation='relu')(input1)
dense2 = Dense(9000, activation='relu')(dense1)
drop1 = Dropout(0.2)(dense2)
dense3 = Dense(7000, activation='relu')(drop1)
drop2 = Dropout(0.2)(dense3)
dense4 = Dense(3000, activation='relu')(drop2)
drop3 = Dropout(0.2)(dense4)
dense5 = Dense(2000, activation='relu')(drop3)
drop4 = Dropout(0.2)(dense5)
dense6 = Dense(1000, activation='relu')(drop4)
