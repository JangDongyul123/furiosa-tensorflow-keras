...
| **03** | **✂️ 데이터 분리와 MSE**<br>Train / Test Split · `train_test_split` · Mean Squared Error<br><br>📘 [3일차 필기 보기](./keras/3일차%20필기.md)<br>✍️ [MSE · RMSE · RMSLE · R²의 관계](https://velog.io/@wordi/MSE-RMSE-RMSLE-R2%EC%9D%98-%EA%B4%80%EA%B3%84) |
| **04** | **📈 회귀와 분류**<br>데이터의 중요성 · Regression · Classification · 데이터 전처리<br><br>📘 [4일차 필기 보기](./keras/4일차%20필기.md)<br>✍️ [편미분과 체인룰로 Gradient를 직접 계산해보자](https://velog.io/@wordi/%ED%8E%B8%EB%AF%B8%EB%B6%84%EA%B3%BC-%EC%B2%B4%EC%9D%B8%EB%A3%B0%EB%A1%9C-Gradient%EB%A5%BC-%EC%A7%81%EC%A0%91-%EA%B3%84%EC%82%B0%ED%95%B4%EB%B3%B4%EC%9E%90)  |
