...
\<img src="https\://img.shields.io/badge/Study\_Notes-13-4C566A?style=flat-square" alt="Study Notes">

\<img src="https\://img.shields.io/badge/Practice\_Files-125-5E81AC?style=flat-square" alt="Practice Files">
...
\| \`keras01.py\` \~ \`keras08\_\*.py\`   | Keras 기초 · Dense · Batch · 행렬 · 다중 입력 / 출력       |

\| \`keras09\_\*.py\` \~ \`keras20\_\*.py\` | 데이터 분리 · 회귀 · 평가 지표 · Validation · EarlyStopping |

\| \`keras21\_\*.py\` \~ \`keras28\_\*.py\` | 이진 분류 · 다중 분류 · Input Shape · Scaling            |

\| \`keras29\_\*.py\` \~ \`keras32\_\*.py\` | 모델 저장 / 불러오기 · Weight · ModelCheckpoint          |

\| \`keras33\_\*.py\`                  | Dropout                                          |

\| \`keras34\_\*.py\`                  | Functional API                                   |

\| \`keras35\_\*.py\`                  | GPU 실행 테스트                                       |

\| \`keras36\_\*.py\`                  | CNN · MNIST                                      |
...
![TensorFlow]\(https\://img.shields.io/badge/Made\_with-TensorFlow-FF6F00?style=flat-square\\&logo=tensorflow\\&logoColor=white)

![Keras]\(https\://img.shields.io/badge/Deep\_Learning-Keras-D00000?style=flat-square\\&logo=keras\\&logoColor=white)
