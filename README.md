...
| 일차 | 학습 내용 및 링크 |
|:---:|---|
| **1일차** | **신경망 기초**<br>개발 환경, Batch, 신경망, 가중치와 편향, 역전파, Loss<br>[📘 필기 보기](./keras/1일차%20필기.md) |
| **2일차** | **텐서와 행렬**<br>스칼라·벡터·행렬·텐서, 행렬곱, Shape, Sequential 모델<br>[📘 필기 보기](./keras/2일차%20필기.md) |
| **3일차** | **데이터 분리와 MSE**<br>Train/Test 데이터 분리, `train_test_split`, MSE<br>[📘 필기 보기](./keras/3일차%20필기.md) |
| **4일차** | **회귀와 분류**<br>데이터의 중요성, 회귀와 분류, 데이터 전처리<br>[📘 필기 보기](./keras/4일차%20필기.md) · [✍️ 관련 글](https://velog.io/@wordi/MSE-RMSE-RMSLE-R2%EC%9D%98-%EA%B4%80%EA%B3%84) |
| **5일차** | **Dense와 ReLU**<br>Dense Layer, ReLU, Hidden Layer와 Output Layer<br>[📘 필기 보기](./keras/5일차%20필기-%20ReLU.md) · [✍️ 관련 글](https://velog.io/@wordi/%EA%B7%80-%EC%B4%88%ED%8F%89%EB%A9%B4-%EB%89%B4%EB%9F%B0-ReLU-%EC%88%9C%EC%A0%84%ED%8C%8C%EC%99%80-%EC%97%AD%EC%A0%84%ED%8C%8C) |
| **6일차** | **Validation과 EarlyStopping**<br>Validation, 과적합, History 시각화, EarlyStopping<br>[📘 필기 보기](./keras/6일차%20필기.md) |
| **7일차** | **과적합과 이진 분류**<br>학습 시간 측정, 과적합 방지, 이진 분류<br>[📘 필기 보기](./keras/7일차%20필기.md) · [✍️ 관련 글](https://velog.io/@wordi/%EB%B6%84%EB%A5%98-%EB%AA%A8%EB%8D%B8%EC%97%90%EC%84%9C-loss-%ED%95%A8%EC%88%98-%EC%84%B1%EB%8A%A5-%EB%B9%84%EA%B5%90-Mean-Squared-Error-VS-Cross-Entropy) |
| **8일차** | **문제 유형 비교**<br>회귀, 이진 분류, 다중 분류 비교<br>[📘 필기 보기](./keras/8일차%20필기.md) |
| **9일차** | **다중 분류와 ROC-AUC**<br>Softmax, One-Hot Encoding, Argmax, ROC-AUC, Input Shape<br>[📘 필기 보기](./keras/9일차%20필기.md) |
| **10일차** | **Scaling과 모델 저장**<br>MinMax·Standard·MaxAbs·Robust Scaler, 이상치, 모델 저장<br>[📘 필기 보기](./keras/10일차%20필기.md) |
| **11일차** | **Functional API와 Dropout**<br>Sequential·Functional 모델, Dropout, Branch, Ensemble<br>[📘 필기 보기](./keras/11일차%20필기.md) · [✍️ 관련 글](https://velog.io/@wordi/Dropout%EC%9D%84-%EC%95%84%EC%A3%BC-%EC%89%BD%EA%B2%8C-%EC%9D%B4%ED%95%98%EA%B8%B0) |
